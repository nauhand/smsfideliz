...
@section('is-active-rechsouscompte')
active
@endsection
                        ...
                        <div class="col-xl-8 col-md-12">
                            <div class="card user-activity-card">
                                <div class="card-header text-center">
                                    <h5>Recharger un sous-compte</h5>
                                    <span>
                                ...
                                <div class="card-block">
                                    <form action="">
                                        <div class="col-xl-12">
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <label for="" style="font-weight: bold;">Sous-compte à recharger (*)</label>
                                                    <div class="input-group input-group-primary">
                                                    <select class="selectpicker form-control" data-style="btn-info">
                                                          <option selected>Natan</option>
                                                          <option>Moowgli</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-xl-12">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-8 offset-2">
                                                    <button type="submit" style="width:100%;"  class="btn btn-md btn-success" id="modal1" class="btn btn-primary"><i class="fas fa-coins"></i> Recharger le sous-compte</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
