...
$(document).ready(function() {
    ...
    $('#btnsend').on('click', function(){
        swal({
          title: "Etes vous d'accord ?",
          text: "Votre campagne sera lancé et les numéros recevrons les sms automatiquement !",
          icon: "warning",
          buttons: true,
          dangerMode: true,
        })
        .then((willDelete) => {
          if (willDelete) {
            swal("Début de la campagne ...", {
              icon: "success",
            });
          } else {
            swal("Revérifiez vos informations de campagne!");
          }
        });
    });
...
$('#styleSelector').append('' +
    ...
    $('#message').keyup(function() {
      ...
      $remaining.text(remaining + ' caractères');
